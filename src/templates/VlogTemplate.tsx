  ...
  if (postData) {
    return (
      <div style={{ background: 'var(--bg-color)', color: 'var(--text-color)', minHeight: '100vh', display: 'flex', flexDirection: 'column', fontFamily: "'Inter', sans-serif" }}>
        <VlogNavbar settings={settings} siteName={siteName} navPages={navPages} currentSlug={currentSlug} subdomain={subdomain} />
        <main style={{ flex: 1 }}>
          <UnifiedPostLayout postData={postData} currentSlug={currentSlug} />
        </main>
        <VlogFooter settings={settings} siteName={siteName} footerCfg={footerCfg} />
      </div>
    );
  }
          ...
          <div className="animate-in fade-in duration-1000">
             <section style={{ height: '70vh', position: 'relative', overflow: 'hidden' }}>
                ...
                <div style={{ position: 'relative', zIndex: 1, padding: '15vh 6vw', maxWidth: '1200px' }}>
                   <div style={{ display: 'inline-flex', alignItems: 'center', gap: '0.75rem', padding: '0.5rem 1.5rem', background: 'var(--primary-color)', color: '#FFF', borderRadius: '5px', fontWeight: 900, fontSize: '0.7rem', textTransform: 'uppercase', letterSpacing: '0.3em', marginBottom: '3rem' }}>
                   ...
                   <Link to={`/preview/${subdomain}/news`} style={{ display: 'flex', alignItems: 'center', gap: '1.5rem', textDecoration: 'none' }}>
                      <div style={{ width: '80px', height: '80px', background: 'var(--primary-color)', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#FFF' }}>
             ...
             <div style={{ padding: '4rem 6vw', display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '4rem', background: '#121212', borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
                {[
                  ...
                  <div key={i} style={{ display: 'flex', gap: '2rem', alignItems: 'center' }}>
                     <div style={{ width: '48px', height: '48px', background: 'rgba(255,255,255,0.05)', borderRadius: '12px', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--primary-color)', flexShrink: 0 }}>
          ...
          <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '10rem 4vw' }} className="animate-in fade-in duration-700">
             <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.3fr', gap: '10rem', alignItems: 'center' }}>
                <div style={{ padding: '6rem', background: '#121212', borderRadius: '3rem', border: '1px solid rgba(255,255,255,0.05)' }}>
                   <div style={{ width: '120px', height: '2px', background: 'var(--primary-color)', marginBottom: '4rem' }} />
                  ...
                  <Link key={post.id} to={`/preview/${subdomain}/${post.slug}`} style={{ textDecoration: 'none', color: 'inherit' }}>
                     <article className="group">
                        ...
                        <div style={{ display: 'flex', gap: '1.5rem' }}>
                           <div style={{ width: '40px', height: '40px', background: 'var(--primary-color)', borderRadius: '50%', flexShrink: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#FFF' }}>
                              <User size={20} />
                           </div>
                           <div>
...
function VlogNavbar({ settings, siteName, navPages, currentSlug, subdomain }: any) {
  return (
    <nav style={{ height: '80px', padding: '0 4vw', display: 'flex', alignItems: 'center', justifyContent: 'space-between', background: 'rgba(15,15,15,0.85)', position: 'sticky', top: 0, zIndex: 100, backdropFilter: 'blur(30px)', borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
      ...
      <div style={{ display: 'flex', gap: '2rem', alignItems: 'center' }}>
         ...
         <Link to={`/preview/${subdomain}/contact`} style={{ padding: '0.75rem 2.2rem', background: 'var(--primary-color)', color: '#FFF', borderRadius: '100px', fontWeight: 900, fontSize: '0.75rem', textTransform: 'uppercase', textDecoration: 'none' }}>
            SUBSCRIBE
         </Link>
      </div>
    </nav>
...
function VlogFooter({ settings, siteName, footerCfg }: any) {
      ...
      <div style={{ maxWidth: '1800px', margin: '0 auto', display: 'grid', gridTemplateColumns: '2fr 1fr 1fr 2fr', gap: '10rem' }}>
        <div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '2rem', marginBottom: '4rem' }}>
            <div style={{ width: '40px', height: '40px', background: 'var(--primary-color)', borderRadius: '10px' }} />
            <span style={{ fontWeight: 950, fontSize: '1.6rem', color: '#FFF', letterSpacing: '-0.04em', textTransform: 'uppercase', fontStyle: 'italic' }}>{siteName}</span>
          </div>
